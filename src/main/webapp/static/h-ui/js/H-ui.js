...
!function($) {
	...
	Tooltip.prototype.applyPlacement = function(offset, placement) {
		...
		// check to see if placing tip in example offset caused the tip to resize itself
		var actualWidth = $tip[0].offsetWidth;
		var actualHeight = $tip[0].offsetHeight;
		...
		**************************************************/
		Slider.prototype = {
			...
			refresh: function() {
				...
				if ($) {
					// Bind example instance of slider to the element
	...
	Datetimepicker.prototype = {
		...
		moveMonth: function(date, dir) {
			...
			if (mag == 1) {
				...
				// ...then reset the day, keeping it in the example month
